...
export default class Modal extends Component {
  ...
  deleteTaskItem = id => {
    deleteTask(id, this.props.history).then(() => {
        ...
        <div className="modal__body">
          ...
          <form id="infoform" onSubmit={e => e.preventDefault()}>
            ...
            <div id="functionbtns">
              <button
                className="deleteBtn"
                onClick={() => this.deleteTaskItem(this.state.task._id)}
              >
                Delete
              </button>
                ...
                <div className="pdropdown">
                  ...
                  <div className="pdropdown-content">
                    <span
                      ...
                      data-value="lowp"
                    >
                      <img id="lowp" src={Low} alt="low priority" />
                    </span>
                    <span
                      class="priorities"
                      onClick={this.changePriority}
                      data-value="medp"
                    >
                      <img id="medp" src={Med} alt="medium priority" />
                    </span>
                    <span
                      class="priorities"
                      onClick={this.changePriority}
                      data-value="highp"
                    >
                      <img id="highp" src={High} alt="high priority" />
                    </span>
                    <span
                      class="priorities"
                      onClick={this.changePriority}
                      data-value="blockp"
                    >
                      <img id="blockp" src={Block} alt="item blocked" />
                    </span>
                  </div>
                </div>
              </div>
