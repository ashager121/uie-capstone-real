      ...
      <div className="editProfileContainer">
        ...
        <div className="editProfile">
          <form className="editProfile__form" onSubmit={this.handleSubmit}>
            <label className="editProfile__label">Update Name</label>
            <input
            ...
            />
            <label className="editProfile__label">Update Email Address</label>
            <input
              className="editProfile__input"
              type="text"
              value={this.state.value}
            ...
            <label className="editProfile__label">Update Password</label>
            <input
              className="editProfile__input"
              type="text"
              value={this.state.value}
            ...
            <label className="editProfile__label">Confirm New Password</label>
            <input
              className="editProfile__input"
              type="text"
              value={this.state.value}
            ...
            <label className="editProfile__label">Update Avatar</label>
